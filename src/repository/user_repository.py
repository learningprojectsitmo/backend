...
from src.schema.user import UserCreate, UserUpdate, UserPermissionCreate, UserPermissionListResponse
...
class UserPermissionRepository(BaseRepository[UserPermission, UserPermissionCreate, BaseModel]):
    ...
    async def get_user_permissions(self, user_id: int) -> UserPermissionListResponse | None:
        result = await self.uow.session.execute(
