...
from src.api.v1.endpoints.role import role_router

routers = APIRouter(prefix="/v1")
router_list = [auth_router, user_router, role_router, resume_router, project_router, sessions_router, audit_router]
