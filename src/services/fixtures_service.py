...
class FixtureService:
    ...
    async def _seed_roles(self) -> None:
        ...
        teacher_matrix = {
            ...
            "workspace": {"create": True, "read": True, "update": True, "delete": False},
            "settings": {"create": False, "read": True, "update": False, "delete": False},
            "audit": {"create": False, "read": True, "update": False, "delete": False},
            "ideas": {"create": True, "read": True, "update": True, "delete": False},
            "kanban": {"create": True, "read": True, "update": True, "delete": False},
        ...
        member_matrix = {
            ...
            "ideas": {"create": True, "read": True, "update": True, "delete": False},
            "kanban": {"create": True, "read": True, "update": True, "delete": False},
            "notification": {"create": True, "read": True, "update": False, "delete": False},
            "invitation": {"create": True, "read": True, "update": False, "delete": False},
            "session": {"create": False, "read": True, "update": False, "delete": False},
            "role": {"create": False, "read": False, "update": False, "delete": False},
            "perm": {"create": False, "read": False, "update": False, "delete": False},
        }
        manager_matrix = {
